...
def zufaellige_mehrfachauswahl():
    ...
    auswahl = random.sample(zahlen, 3)      # es werden mit der funktion: .sample() 3 eindeutige Elemente, aus der variable: 'zahlen' ausgewählt und in der variable: 'auswahl' gespeichert
